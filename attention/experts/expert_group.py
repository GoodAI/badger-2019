...
from attention.agents.agent import DeviceAwareModule
from attention.models.attention.multi_unit_attention import AttentionUnit, MultiUnitAttention, AttentionMessages

from typing import TYPE_CHECKING

if TYPE_CHECKING:
    from attention.experts.units.expert_unit import ExpertUnit
...
@dataclass
class ExpertInitRolloutParams:
    reset_expert_id: bool


class ExpertGroup(DeviceAwareModule, AttentionUnit[None, List[Tensor], ExpertInitRolloutParams]):
    attn: MultiUnitAttention[ExpertHiddenStateParams, ExpertInitRolloutParams]
    ...
    def __init__(self, hidden_state_size: int, key_size: int, id_size: int, device: Optional[str] = None):
        ...
        self.attn = MultiUnitAttention[ExpertHiddenStateParams, ExpertInitRolloutParams](
            self.units,
    ...
    def init_rollout(self, batch_size: int, n_experts: int, params: ExpertInitRolloutParams):
        ...
        self.attn.init_rollout(batch_size, n_experts, params)
        if params.reset_expert_id:
