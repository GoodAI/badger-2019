...
class ActionModuleAdapted(nn.Module):
    """
    ...
    def __init__(self, config):
        super(ActionModuleAdapted, self).__init__()
        self.using_utterances = config.use_utterances
        self.using_cuda = config.use_cuda
        self.goal_processor = ProcessingModuleAdapted(config.goal_processor)
        self.processor = ProcessingModuleAdapted(config.action_processor)
