import numpy as np
from marl.marl.environments.particles.multiagent.core import World, Agent, Landmark
# from multiagent.scenarios import BaseScenario
from multiagent.scenarios.base_scenario import BaseScenario
...
class Scenario(BaseScenario):
    ...
    def adversary_reward(self, agent, world):
        # keep the nearest good emergent_comm away from the goal
    ...
    def observation(self, agent, world):
        ...
        if not agent.adversary:
            ...
            #other_pos = list(reversed(other_pos)) if random.uniform(0,1) > 0.5 else other_pos  # randomize position of other emergent_comm in adversary network
